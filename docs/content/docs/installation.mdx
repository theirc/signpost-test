...
```bash
git clone https://github.com/your-org/signpost-ai.git
cd signpost-ai
```
...
1. Check the [GitHub Issues](https://github.com/your-org/signpost-ai/issues)
2. Join our [Discord community](https://discord.gg/signpost-ai)
...
1. **Read the [Quick Start Guide](/docs/quick-start)** to build your first agent
2. **Explore the [Core Concepts](/docs/core-concepts)** to understand the framework
3. **Check out [Examples](/docs/examples)** to see what's possible

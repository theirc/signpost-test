...
- **[Structured Output](/workers/generators/structuredoutput)**: Ensures consistent response formatting with structured output
...
- **[STT](/workers/tools/stt)**: Speech-to-text conversion
